...
int main(int argc, char** argv) 
{
	...
	priority = (unsigned long)atoll(argv[8]);
	printf("Task:%d ready to execute. Priority: %lu\n",task_id, priority);
	...
	if(syscall(__NR_casio_sched_setscheduler,task_id,h,l, priority)){
